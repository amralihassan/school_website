          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <!-- students Information -->
                <li>
                  <a href="#" onclick="studentInfo();">
                    <i class="fa  fa-child"></i> <span>My Kids</span>
                  </a>
                </li>            
              ...
              <!-- attandance -->
                <li>
                  <a href="#" onclick="studentReport();">
                    <i class="fa fa-table"></i> <span>Student Report</span>
                  </a>
                </li>       
      ...
      <script type="text/javascript">
        ...
        function payments()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Payments/load_payments_parent',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#pagetitle').html(response.pagetitle);
        ...
        function studentInfo()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Student/load_my_kids',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#pagetitle').html(response.pagetitle);
        ...
        function homework()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Homework/load_parent_homework',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#maintitle').html(response.pagetitle);
        ...
        function sheet()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Sheet/load_sheet_parent',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#pagetitle').html(response.pagetitle);
        ...
        function exam()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Exam/loadexams_parent',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#pagetitle').html(response.pagetitle);
        ...
        function studentReport()
        {
            $.ajax({
                type:'ajax',
                method:'get',
                url:'<?php echo base_url() ?>Student/load_studentReport',
                async:false,
                dataType:'json',
                success:function(response){
                    $('#pagetitle').html(response.pagetitle);
