		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#list" aria-controls="list" role="tab" data-toggle="tab">Supply List</a></li>
						        ...
						        <div class="panel-body">
						        	<div class="row">
						        		...
						        		<div class="col-lg-10">
											<!-- my kids -->
											<div class="dropdown"  >
												<button style="width: 300px;" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select Supplies List
											  	<span class="caret"></span></button>
											 	 	<ul class="dropdown-menu" style="width: 275px;" id="supplies_find">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #065293; color: #d5dee0;">
				<h4 class="modal-title">Delete supply list</h4>
			</div>
			<div class="modal-body">
				Do you want to delete this supply list?
			</div>
...
<script type="text/javascript">
	...
	function searchData() 
	{
		...
		// '<a target="_blanke" href="'. base_url('public/upload/sup/').$row->file_name.'">'.$row->title.'</a>'
	}
