  ...
  <div class="modal-dialog" role="document">
    ...
    <script type="text/javascript">   
      ...
      function load_administrtors()
      {
          $.ajax({
              type:'ajax',
              url:'<?php echo base_url() ?>Administrator/retriveadministrative',
              dataType:'json',
      ...
      function load_students()
      {
        ...
        $.ajax({
          type:'ajax',
          url:'<?php echo base_url() ?>Student/retrive_student_by_class',
          dataType:'json',
          success:function(data)
          {
            $('#stu_id').html(data);
      ...
      function load_teachers()
      {
        ...
        $.ajax({
          url:'<?php echo base_url() ?>Administrator/retrive_users_mail_teachers',
          method:'get',
