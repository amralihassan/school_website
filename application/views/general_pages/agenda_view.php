	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li class="active"><a href="#fday" aria-controls="fday" role="tab" data-toggle="tab">Agenda</a></li>
			...
			<div class="tab-content">
					...
					<div class="row"> 
						<div class="col-lg-12">
							...
							<div class="panel panel-primary">
						        ...
						        <div class="panel-body" style="overflow-y: auto;min-height: 900px; ">
						        	<!-- search -->
						        	<div class="row">
						        		<div class="col-lg-12">
				...
				<div role="tabpanel" class="tab-pane" id="sday">
					<div class="panel panel-primary">
						 <div class="panel-heading">
						 	Add Event or Activity
						 </div>
						 <div class="panel-body" style="max-height:1500px;overflow-y: auto;min-height:550px; ">
							<div class="row">
								<div class="col-lg-12">
									<!--form  -->
									<form id="myForm_agenda" action="" method="post">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-lg-9">
													<textarea class="form-control" name="details_add" required="required">
												</textarea>
												</div>
											</div>											
										</div>
...
<script type="text/javascript">
	...
	$('#btnAdd_agenda').click(function(){
		...
		$.ajax({
			type:'ajax',
			url:'<?php echo base_url() ?>Agenda/retrivedivision',
			dataType:'json',
			success:function(data)
			{
				$('#division').html(data);
		...
		$.ajax({
			type:'ajax',
			url:'<?php echo base_url() ?>Agenda/retrivegrade',
			dataType:'json',
			success:function(data)
			{
				$('#grade').html(data);
